...
#define ssid "SSID"     // Put you're WiFi SSID here
#define pswd "PSWD"     // Put you're WiFi PSWD here
...
void setup()
{
  ...
  Wire.begin();
  // Initialize the control register of the DS3231 module
  DS3231_init(0x00);
...
void loop()
{
  // Get date and time from the DS3231 module and print it in the serial monitor
  DS3231_get(&t);
  char currentTime[8];
  sprintf(currentTime, "%d:%d:%d", t.hour, t.min, t.sec);
  Serial.print("Current time: ");
  Serial.println(currentTime);
  char currentDate[9];
  sprintf(currentDate, "%d/%d/%d", t.mday, t.mon, t.year);
